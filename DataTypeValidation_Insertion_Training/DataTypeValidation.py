...
class dBOperation:
    ...
    def createTableDb(self,DatabaseName,column_names):
        """
                        ...
                        """
        try:
            self.dbObj.createOrGetCollection('forestCoverDB', 'Good_Raw_Data')
    ...
    def insertIntoTableGoodData(self,Database):
        ...
        self.dbObj.dropCollection('forestCoverDB', 'Good_Raw_Data')
        for file in onlyfiles:
            try:
                df_csv = self.azureObj.csvToDataframe(self.goodFilePath, file)
                self.dbObj.dataframeToRecords('forestCoverDB','Good_Raw_Data',df_csv)
