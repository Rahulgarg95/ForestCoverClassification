...
class dBOperation:
    ...
    def createTableDb(self,DatabaseName,column_names):
        ...
        """
        try:
            self.dbObj.createOrGetCollection('forestCoverDB', 'Pred_Good_Raw_Data')
    ...
    def insertIntoTableGoodData(self,Database):
        ...
        for file in onlyfiles:
            try:
                ...
                self.dbObj.dataframeToRecords('forestCoverDB', 'Pred_Good_Raw_Data', df_csv)
    ...
    def selectingDatafromtableintocsv(self,Database):
        ...
        try:
            tmp_csv = self.azureObj.recordsToDataFrame(Database, 'Pred_Good_Raw_Data')
